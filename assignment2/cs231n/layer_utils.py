...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
    ...
    Inputs and outputs are the same as affine_relu_forward.
    """
    a, fc_cache = affine_forward(x, w, b)
...
def affine_ln_relu_forward(x, w, b, gamma, beta, ln_param):
    """Convenience layer that performs an affine transform followed by layer normalization and a ReLU.

    Inputs and outputs are the same as affine_relu_forward.
    """
    a, fc_cache = affine_forward(x, w, b)
    a1, ln_cache = layernorm_forward(a, gamma, beta, ln_param)
    out, relu_cache = relu_forward(a1)
